                ...
                <div class="col-xl-6 col-lg-7">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li class="active"><a href="{{ route('category') }}">Shop</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="dropdown">
            ...
            <div class="row">
                    ...
                    <div class="product__details__pic">
                        {{-- <div class="product__details__pic__left product__thumb nice-scroll">
                            <a class="pt active" href="#product-1">
                                <img src="{{asset('home/img/product/details/thumb-1.jpg')}}" alt="">
                            </a>
                            <a class="pt" href="#product-2">
                                <img src="{{asset('home/img/product/details/thumb-2.jpg')}}" alt="">
                            </a>
                            <a class="pt" href="#product-3">
                                <img src="{{asset('home/img/product/details/thumb-3.jpg')}}" alt="">
                            </a>
                            <a class="pt" href="#product-4">
                                <img src="{{asset('home/img/product/details/thumb-4.jpg')}}" alt="">
                            </a>
                        </div> --}}
                        <div class="product__details__slider__content">
                            <div class="product__details__pic__slider owl-carousel">
                                <img data-hash="product-1" class="product__big__img" src="{{ asset($product->product_img) }}" alt="">
                                {{-- <img data-hash="product-2" class="product__big__img" src="{{asset('home/img/product/details/product-3.jpg')}}" alt="">
                                <img data-hash="product-3" class="product__big__img" src="{{asset('home/img/product/details/product-2.jpg')}}" alt="">
                                <img data-hash="product-4" class="product__big__img" src="{{asset('home/img/product/details/product-4.jpg')}}" alt=""> --}}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="product__details__text">
                        <h3>{{ $product->product_name }}<span>Brand: {{ $product->slug }}</span></h3>
                        <div class="rating">
                        ...
                        <div class="product__details__button">
                            <form action="{{ route('addproducttocart', $product->id) }}" method="POST">
                                ...
                                <div class="quantity">
                                    <span>Quantity:</span>
                                    <div class="pro-qty" for="quantity">
                                        <input class="form-control" type="text" value="1" placeholder="1" name="quantity">
                                    </div>
                                </div>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="stock__checkbox">
                                        <label for="stockin">{{ $product->product_category_name }}</label>
                                    </div>
                                </li>
                                <li>
            ...
            <div class="row">
                ...
                {{-- <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{asset('home/img/product/related/rp-1.jpg')}}">
                            <div class="label new">New</div>
                            <ul class="product__hover">
                                <li><a href="{{asset('home/img/product/related/rp-1.jpg')}}" class="image-popup"><span class="arrow_expand"></span></a></li>
                                <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{ asset($product->product_img) }}">
                            <ul class="product__hover">
                                <li><a href="{{ asset($product->product_img) }}" class="image-popup"><span class="arrow_expand"></span></a></li>
                                <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                <li><a href="{{ route('singleproduct', $product->id) }}"><span class="icon_bag_alt"></span></a></li>
                            </ul>
                        </div>
                        <div class="product__item__text">
                ...
                {{-- <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{asset('home/img/product/related/rp-3.jpg')}}">
                            <div class="label stockout">out of stock</div>
                            <ul class="product__hover">
                                <li><a href="{{asset('home/img/product/related/rp-3.jpg')}}" class="image-popup"><span class="arrow_expand"></span></a></li>
                                <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{asset('home/img/product/related/rp-4.jpg')}}">
                            <ul class="product__hover">
                                <li><a href="{{asset('home/img/product/related/rp-4.jpg')}}" class="image-popup"><span class="arrow_expand"></span></a></li>
                                <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                            </ul>
                        </div>
