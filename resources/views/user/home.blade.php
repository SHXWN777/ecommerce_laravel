        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 p-0">
                    ...
                    data-setbg="{{ asset('home/img/categories/category-1.jpg') }}">
            ...
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="{{ asset('home/img/categories/category-2.jpg') }}">
                            <div class="categories__text">
                                <h4>Men’s fashion</h4>
                                <p>358 items</p>
                                <a href="#">Shop now</a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="{{ asset('home/img/categories/category-3.jpg') }}">
                            <div class="categories__text">
                                <h4>Kid’s fashion</h4>
                                <p>273 items</p>
                                <a href="#">Shop now</a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="{{ asset('home/img/categories/category-4.jpg') }}">
                            <div class="categories__text">
                                <h4>Cosmetics</h4>
                                <p>159 items</p>
                                <a href="#">Shop now</a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="{{ asset('home/img/categories/category-5.jpg') }}">
                            <div class="categories__text">
                                <h4>Accessories</h4>
                                <p>792 items</p>
                                <a href="#">Shop now</a>
...
<section class="banner set-bg" data-setbg="{{ asset('home/img/banner/banner-1.jpg') }}">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
                ...
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{ asset('home/img/trend/ht-1.jpg') }}" alt="">
                        </div>
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{ asset('home/img/trend/ht-2.jpg') }}" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{ asset('home/img/trend/ht-3.jpg') }}" alt="">
                        </div>
                        <div class="trend__item__text">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{ asset('home/img/trend/bs-1.jpg') }}" alt="">
                        </div>
                        <div class="trend__item__text">
                            <h6>Cotton T-Shirt</h6>
                            <div class="rating">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{ asset('home/img/trend/bs-2.jpg') }}" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{ asset('home/img/trend/bs-3.jpg') }}" alt="">
                        </div>
                        <div class="trend__item__text">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{ asset('home/img/trend/f-1.jpg') }}" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{ asset('home/img/trend/f-2.jpg') }}" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{ asset('home/img/trend/f-3.jpg') }}" alt="">
                        </div>
                        <div class="trend__item__text">
        ...
        <div class="row">
            <div class="col-lg-6 p-0">
                <div class="discount__pic">
                    <img src="{{ asset('home/img/discount.jpg') }}" alt="">
                </div>
            </div>
            <div class="col-lg-6 p-0">
