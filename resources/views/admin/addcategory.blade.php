...
<html
  ...
  <head>
    ...
    <title>Dashboard Analytics for Ecommerce</title>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{ route('allcategory') }}" class="menu-link">
                <div data-i18n="Text">All category</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{ route('addcategory') }}" class="menu-link">
                <div data-i18n="Text">Add category</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="{{ route('allsubcategory') }}" class="menu-link">
                <div data-i18n="Text">All sub category</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{ route('addsubcategory') }}" class="menu-link">
                <div data-i18n="Text">Add sub category</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="{{ route('allproduct') }}" class="menu-link">
                <div data-i18n="Text">All product</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{ route('addproduct') }}" class="menu-link">
                <div data-i18n="Text">Add product</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="{{ route('pendingorder') }}" class="menu-link">
                <div data-i18n="Text">Pending orders</div>
              </a>
            </li>
            <li class="menu-item">
              <a target="_blank" class="menu-link">
                <div data-i18n="Text">Completed orders</div>
              </a>
            </li>
            <li class="menu-item">
              <a target="_blank" class="menu-link">
                <div data-i18n="Text">Cancel orders</div>
              </a>
            </li>
              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="{{ route('storecategorys') }}" method="POST">
                        @csrf
